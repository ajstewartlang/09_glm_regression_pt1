...
<iframe width="560" height="315" src="https://youtube.com/embed/bvnrq_nx_BI" data-external="1" frameborder="0" allowfullscreen></iframe>
...
You can download the slides in .odp format by clicking [here](../slides/glm_pt1.odp) and in .pdf format by clicking on the image below. 

&nbsp;&nbsp;

<center>

[![Link to GLM Regression part 1 slides](../images/glm_pt1.png){width=75%}](../slides/glm_pt1.pdf)
...
If you'd like to run the analysis that I go through in the video above, you can download the F1 dataset containing the Points and Investment variables and map it onto the variable name `dataset1` like this:

`dataset1 <- read_csv("https://raw.githubusercontent.com/ajstewartlang/09_glm_regression_pt1/master/data/dataset1.csv")`

# Simple Linear Regression
After having watched the video above, I'd like you to work through the following simple linear regression example. Remember to create a new `.Rproj` file to keep things organised.
